...
var SAVE_COLOR=["#a6cb12","#364e68","#94d2e6","#6b76ff","#5c8d89","#c5d86d","#fbeed7","#8293ff","#829d3f"] // web安全色
...
function renderInfoButton(data) {
    ...
    $("#userInfoContainer").html("<button class=\"dropdown-item\" type=\"button\" onclick=\"location.href='/p/homepage.html'\">个人主页</button>\n" +
        "                <button class=\"dropdown-item\" type=\"button\" onclick=\"logout()\">注销</button>");
}
        ...
        switch (temp) {
            case "USER":
                if (permissionRetrieval[temp]) {
                    $("#permissionButtonList").append("<li class=\"list-group-item\"><a href=\"user.html\">用户管理</a></li>");
                }
                break;
            case "RESOURCE":
                if (permissionRetrieval[temp]) {
                    $("#permissionButtonList").append("<li class=\"list-group-item\"><a href=\"resource.html\">资源管理</a></li>");
                }
                break;
            case "PERMISSION":
                if (permissionRetrieval[temp]) {
                    $("#permissionButtonList").append("<li class=\"list-group-item\"><a href=\"permission.html\">权限管理</a></li>");
                }
                break;
            case "MESSAGE":
                if (permissionRetrieval[temp]) {
                    $("#permissionButtonList").append("<li class=\"list-group-item\"><a href=\"message.html\">消息管理</a></li>");
                }
                break;
            case "NOTICE":
                if (permissionRetrieval[temp]) {
                    $("#permissionButtonList").append("<li class=\"list-group-item\"><a href=\"notice.html\">公告管理</a></li>");
                }
                break;
            case "LINK":
                if (permissionRetrieval[temp]) {
                    $("#permissionButtonList").append("<li class=\"list-group-item\"><a href=\"link.html\">外链管理</a></li>");
                }
                break;
        }
    }
...
function renderLeftNotice(data) {
    ...
    if (data.longTerm.length == 0) {
        $("#longTermNoticeContainer").append("<p style='text-align: center'><small>暂无公告</small></p>")
    }
