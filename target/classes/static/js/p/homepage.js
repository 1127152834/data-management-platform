        ...
        $('#articleTable').bootstrapTable({
            ...
            columns: [ {
                ...
                formatter:function (value,row) {
                    return '<div style="display: flex;justify-content: space-around"><a class="btn active btn-sm btn-primary" href="../article.html?id='+value+'">查看</a>' +
                        '<a class="btn active btn-sm btn-danger" href="javascript:deleteArticle(\''+value+'\')">删除</a></div>';
                }
            }]
        });
    };
    ...
    oTableInit.Init = function () {
        $('#resourceTable').bootstrapTable({
            ...
            columns: [{
                ...
                title: '操作',
                formatter: function(value, row, index) {
                    return '<div style="display: flex;justify-content: space-around"><a class="btn active btn-sm btn-primary" href="../resource-view.html?id='+value+'">查看</a>' +
                        '<a class="btn active btn-sm btn-danger" href="javascript:deleteResource(\''+value+'\')">删除</a></div>';
                }
            } ]
        });
    };
