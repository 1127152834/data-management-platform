            ...
            columns: [{
                ...
                formatter: function(value, row, index) {
                    return [
                        ...
                        '<div style="display: flex;justify-content: space-around"><button class="btn active btn-sm btn-warning" onclick="editUser(\''+value+'\','+index+')">修改</button>' +
                        '<button class="btn active btn-sm btn-info" onclick="showPasswordModal(\''+value+'\')">密码</button>' +
                        '<button class="btn active btn-sm btn-danger" onclick="deleteUser(\''+value+'\')">删除</button></div>'
                    ].join('');
                }
            } ]
        });
