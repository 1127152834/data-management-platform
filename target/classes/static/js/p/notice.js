        ...
        $('#noticeTable').bootstrapTable({
            ...
            columns: [ {
                ...
                formatter:function (value,row) {
                    return '<div style="display: flex;justify-content: space-around"><a class="btn active btn-sm btn-primary" href="../notice-view.html?id='+value+'">查看</a>' +
                        '<a class="btn active btn-sm btn-danger" href="javascript:deleteNotice(\''+value+'\')">删除</a></div>';
                }
            }]
        });
    };
