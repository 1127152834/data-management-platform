                ...
                case 0:
                    ...
                    for (var i = 0; i < res.data.length; i++) {
                        $("#downloadHotResource").append("<div class=\"col-sm-12 col-md-4\" align=\"center\">\n" +
                            ...
                            "                                    <a href=\"../resource-view.html?id="+res.data[i].resource.id+"\" class=\"btn btn-primary\">查看</a>\n" +
                            "                                </div>\n" +
                            "                            </div>\n" +
                            "                        </div>");
                    }
                ...
                case 0:
                    for (var i = 0; i < res.data.rows.length; i++) {
                        ...
                        $("#articleList").append("<div class=\"card-body card-list\">\n" +
                            ...
                            "                                    <a href=\"../article.html?id="+res.data.rows[i].article.id+"\" class=\"btn btn-primary\">查看</a>\n" +
            ...
            switch (res.status) {
                ...
                case 0:
                    for (var i = 0; i < res.data.length; i++) {
                        ...
                        $("#resourceList").append("<div class=\"row card-body card-list\">\n" +
                            "                                    <div class=\"col-12\">\n" +
                            "                                        <div class=\"d-flex w-100 justify-content-between\">\n" +
                            "                                            <h5 class=\"card-title\">"+res.data[i].resource.title+"</h5>\n" +
                            "                                            <small class=\"text-muted text-right\">"+createTime+"</small>\n" +
                            ...
                            "                                        <img src=\""+res.data[i].resource.imgUrl+"\" class=\"rounded mx-auto d-block\" style=\"max-width: 100%;\">\n" +
                            "                                    </div>\n" +
